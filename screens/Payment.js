  ...
  return (
    ...
    >
      ...
      <View style={styles.logoContainer}>
        <Image source={require("../logo/bill.png")} style={styles.logo} />
      </View>
      ...
      <Button
       ...
       <Text>{JSON.stringify(informBooking, ['vehicleMade']).replaceAll("vehicleMade", "VEHICLE ").replaceAll("{", " ").replaceAll("}", " ").replaceAll( '"' , " ").replaceAll( "[", " ").replaceAll( "]", " ").replaceAll( ",", " ").replaceAll(/\\/g, ' ') + "\n"}</Text>
       <Text>{JSON.stringify(informBooking, ['vehicleLicence']).replaceAll("vehicleLicence", "LICENCE ").replaceAll("{", " ").replaceAll("}", " ").replaceAll( '"' , " ").replaceAll( "[", " ").replaceAll( "]", " ").replaceAll( ",", " ").replaceAll(/\\/g, ' ') + "\n"}</Text>
       <Text>{JSON.stringify(informBooking, ['bookingRequired']).replaceAll("bookingRequired", "BOOKING ").replaceAll("{", " ").replaceAll("}", " ").replaceAll( '"' , " ").replaceAll( "[", " ").replaceAll( "]", " ").replaceAll( ",", " ").replaceAll(/\\/g, ' ') + "\n"}</Text>
      <Text>{JSON.stringify(informBooking, ['cost']).replaceAll("cost", "EXTRA COST ").replaceAll("{", " ").replaceAll("}", " ").replaceAll( '"' , " ").replaceAll( "[", " ").replaceAll( "]", " ").replaceAll( ",", " ").replaceAll(/\\/g, ' ') + "\n"}  </Text>   
       <Text>TOTAL DUE: <Text>{JSON.stringify(informBooking, ['bookingRequired']).replaceAll("bookingRequired", " ").replaceAll("{", " ").replaceAll("}", " ").replaceAll( '"' , " ").replaceAll( "[", " ").replaceAll( "]", " ").replaceAll( ":", " ").replaceAll( ",", " ").replaceAll(/\\/g, ' ') }</Text> +
      <Text>{JSON.stringify(informBooking, ['cost']).replaceAll("cost", " ").replaceAll("{", " ").replaceAll("}", " ").replaceAll( '"' , " ").replaceAll( "[", " ").replaceAll( "]", " ").replaceAll( ",", " ").replaceAll(/\\/g, ' ').replaceAll( ":", " ")+ "\n"}  </Text>   
       </Text>      
      
      <Text>Payment doing on collection!</Text>
